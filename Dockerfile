...
ARG SERIAL_NUMBER
ENV SERIAL_NUMBER ${SERIAL_NUMBER:-20230330.1000}
...
RUN curl -o blender.tgz https://mirrors.ocf.berkeley.edu/blender/release/Blender3.5/blender-3.5.0-linux-x64.tar.xz && \
